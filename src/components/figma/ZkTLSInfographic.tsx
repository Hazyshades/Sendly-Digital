...
const bottomCard: CardData = {
  ...
  description: 'Signed claim proves ownership without revealing credentials',
};
...
interface ZkTLSInfographicProps {
  compact?: boolean;
  /** When true, omit min-h-screen (e.g. for modal embedding) */
  embedded?: boolean;
}

export function ZkTLSInfographic({
  compact = false,
  embedded = false,
}: ZkTLSInfographicProps) {
