...
function clearInstagramOAuthStorage(): void {
...
export function InstagramCallbackRoute() {
  ...
  useEffect(() => {
    ...
    const storedState =
      localStorage.getItem('instagram_oauth_state') || sessionStorage.getItem('instagram_oauth_state');
    const redirectUrl =
      localStorage.getItem('instagram_oauth_redirect') ||
      sessionStorage.getItem('instagram_oauth_redirect') ||
      '/dashboard';
    ...
    const exchangeCodeForToken = async () => {
      try {
        ...
        const fullUrl = `${apiUrl}/api/instagram/oauth/exchange`;
        ...
        console.error('[POPUP] Instagram code exchange error:', err);
        clearInstagramOAuthStorage();
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center">
        <h2 className="text-xl font-semibold mb-2">Processing Instagram authorization...</h2>
