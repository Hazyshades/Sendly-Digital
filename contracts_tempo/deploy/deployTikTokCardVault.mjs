...
async function main() {
  ...
  console.log("Деплой контракта TikTokCardVault на Arc Testnet...");
  ...
  const artifactPath = join(__dirname, "..", "..", "artifacts", "contracts", "TikTokCardVault.sol", "TikTokCardVault.json");
  ...
  console.log(`VITE_ARC_TIKTOK_VAULT_ADDRESS=${contractAddress}`);
  console.log(`VITE_ARC_TIKTOK_VAULT_CONTRACT_ADDRESS=${contractAddress}`);
}
