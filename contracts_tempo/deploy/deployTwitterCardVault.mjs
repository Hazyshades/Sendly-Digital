...
async function main() {
  ...
  console.log("Деплой контракта TwitterCardVault на Arc Testnet...");
  ...
  const artifactPath = join(__dirname, "..", "..", "artifacts", "contracts", "TwitterCardVault.sol", "TwitterCardVault.json");
  ...
  console.log(`VITE_ARC_TWITTER_VAULT_ADDRESS=${contractAddress}`);
  console.log(`VITE_ARC_TWITTER_VAULT_CONTRACT_ADDRESS=${contractAddress}`);
}
