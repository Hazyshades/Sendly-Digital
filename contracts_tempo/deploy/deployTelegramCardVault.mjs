...
async function main() {
  ...
  console.log("Деплой контракта TelegramCardVault на Arc Testnet...");
  ...
  const artifactPath = join(__dirname, "..", "..", "artifacts", "contracts", "TelegramCardVault.sol", "TelegramCardVault.json");
  ...
  console.log(`VITE_ARC_TELEGRAM_VAULT_ADDRESS=${contractAddress}`);
  console.log(`VITE_ARC_TELEGRAM_VAULT_CONTRACT_ADDRESS=${contractAddress}`);
}
