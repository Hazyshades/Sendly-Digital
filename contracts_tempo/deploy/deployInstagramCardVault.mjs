...
async function main() {
  ...
  console.log("Деплой контракта InstagramCardVault на Arc Testnet...");
  ...
  const artifactPath = join(__dirname, "..", "..", "artifacts", "contracts", "InstagramCardVault.sol", "InstagramCardVault.json");
  ...
  console.log(`VITE_ARC_INSTAGRAM_VAULT_ADDRESS=${contractAddress}`);
  console.log(`VITE_ARC_INSTAGRAM_VAULT_CONTRACT_ADDRESS=${contractAddress}`);
}
