...
/**
 * @title InstagramCardVault
 * @notice Vault for storing gift cards sent via Instagram username
 *
 * Flow:
 * 1. A user calls createGiftCardForInstagram in GiftCard.sol
 * 2. The NFT is minted directly to this contract and linked to the Instagram username
 ...
 */
contract InstagramCardVault is Ownable, IERC721Receiver {
